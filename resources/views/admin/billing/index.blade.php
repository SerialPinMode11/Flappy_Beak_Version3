        ...
        <div class="billing-table">
            <table class="w-full table-fixed divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th scope="col" class="w-12 px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">ID</th>
                        <th scope="col" class="w-56 px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Customer</th>
                        <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Address</th>
                        <th scope="col" class="w-40 px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Payment Method</th>
                        <th scope="col" class="w-32 px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Amount</th>
                        <th scope="col" class="w-32 px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider status-column">Status</th>
                        <th scope="col" class="w-32 px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date</th>
                        <th scope="col" class="w-24 px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider action-column">Actions</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="billing-row" 
                        ...
                        data-id="{{ $info->id }}">
                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900 text-center">{{ $info->id }}</td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">₱{{ number_format($info->total_amount, 2) }}</td>
                        ...
                        <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{{ $info->created_at->format('M d, Y') }}</td>
                        <td class="px-4 py-4 whitespace-nowrap text-sm font-medium action-column text-center">
                            <a href="{{ route('admin.billing.show', $info->id) }}"
                               class="inline-flex items-center justify-center text-indigo-600 hover:text-indigo-900 mx-1"
                               title="View details">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.billing.edit', $info->id) }}"
