...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
    ...
    <nav class="mb-6 flex items-center text-sm text-gray-500" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            <li>
                <a href="{{ route('home') }}" class="hover:text-forest transition-colors">
                    <i class="fas fa-home"></i>
                </a>
            </li>
            <li class="flex items-center space-x-2">
                <i class="fas fa-chevron-right text-xs"></i>
                <a href="#" class="hover:text-forest transition-colors">Products</a>
            </li>
            <li class="flex items-center space-x-2">
                <i class="fas fa-chevron-right text-xs"></i>
                <span class="text-forest">{{ $product->product_name }}</span>
            </li>
        </ol>
    </nav>
        ...
        <div class="md:grid md:grid-cols-2">
            ...
            <div class="relative group">
                <div class="absolute top-4 left-4 z-10">
                    <span class="bg-forest text-white text-sm font-semibold px-4 py-1 rounded-full">
                        Premium Product
                    </span>
                </div>
                ...
                <div class="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                    ...
                    <button class="w-2 h-2 rounded-full bg-forest"></button>
                    <button class="w-2 h-2 rounded-full bg-white opacity-75"></button>
                </div>
            </div>
            ...
            <div class="p-8 lg:p-10">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="#reviews" onclick="document.getElementById('tab-reviews-btn').click(); return false;" class="text-sm text-forest hover:underline">{{ $reviewsCount }} Review{{ $reviewsCount !== 1 ? 's' : '' }}</a>
                    </div>
                ...
                <h1 class="text-3xl font-bold text-forest mb-4">{{ $product->product_name }}</h1>
                
                <div class="mb-6">
                    <div class="flex items-baseline space-x-3">
                        <span class="text-4xl font-bold text-forest">₱{{ number_format($product->product_price, 2) }}</span>
                ...
                <form id="add-to-cart-form" method="POST" action="{{ route('cart.add') }}" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button type="button" id="add-to-cart-button"
                            class="flex-1 bg-forest hover:bg-opacity-90 text-white px-6 py-3 rounded-xl font-semibold transition-colors flex items-center justify-center">
                            <i class="fas fa-shopping-cart mr-2"></i>
                            Add to Cart
                        </button>
                        <button type="button" id="buy-now-button"
                            class="flex-1 bg-gold text-forest hover:bg-gold-deep/90 px-6 py-3 rounded-xl font-semibold transition-colors flex items-center justify-center border-2 border-gold-deep/30 shadow-sm">
                ...
                <div class="mt-8 grid grid-cols-2 gap-4">
                    <div class="flex items-center space-x-3 text-sm text-gray-500">
                        <i class="fas fa-truck text-gold-deep"></i>
                        <span>Free shipping over ₱5000</span>
                    </div>
                    <div class="flex items-center space-x-3 text-sm text-gray-500">
                        <i class="fas fa-shield-alt text-gold-deep"></i>
                        <span>Secure payment</span>
                    </div>
                    <div class="flex items-center space-x-3 text-sm text-gray-500">
                        <i class="fas fa-exchange-alt text-gold-deep"></i>
                        <span>14-day returns</span>
                    </div>
                    <div class="flex items-center space-x-3 text-sm text-gray-500">
                        <i class="fas fa-check-circle text-gold-deep"></i>
        ...
        <div class="border-t border-gray-100">
            <div class="p-6 md:p-8">
                <div class="flex border-b border-gray-200">
                    <button onclick="openTab(event, 'description')" class="tab-button px-6 py-3 text-forest border-b-2 border-forest">
                        Description
                    </button>
                    <button onclick="openTab(event, 'specifications')" class="tab-button px-6 py-3 text-stone-500 hover:text-forest">
                        Specifications
                    </button>
                    <button id="tab-reviews-btn" onclick="openTab(event, 'reviews')" class="tab-button px-6 py-3 text-stone-500 hover:text-forest">
                ...
                <div id="description" class="tab-content py-6">
                    <div class="prose max-w-none text-gray-600">
                        ...
                        <h3 class="text-lg font-semibold text-forest mb-3">Key Features:</h3>
                ...
                <div id="specifications" class="tab-content hidden py-6">
                    <div class="grid md:grid-cols-2 gap-6">
                        <div>
                            <h3 class="text-lg font-semibold text-forest mb-4">Product Specifications</h3>
                            <div class="space-y-3">
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Breed</span>
                                    <span class="font-medium text-forest">Pekin Duck</span>
                                </div>
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Age</span>
                                    <span class="font-medium text-forest">1 month</span>
                                </div>
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Gender</span>
                                    <span class="font-medium text-forest">Drake (Male)</span>
                                </div>
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Average Weight</span>
                                    <span class="font-medium text-forest">1.2 - 1.5 kg</span>
                                </div>
                            </div>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold text-forest mb-4">Care Requirements</h3>
                            <div class="space-y-3">
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Space Needed</span>
                                    <span class="font-medium text-forest">4-5 sq ft</span>
                                </div>
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Water Access</span>
                                    <span class="font-medium text-forest">Daily required</span>
                                </div>
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Feed Type</span>
                                    <span class="font-medium text-forest">Duck grower feed</span>
                                </div>
                                <div class="flex justify-between py-2 border-b">
                                    <span class="text-gray-600">Temperature</span>
                                    <span class="font-medium text-forest">20-25°C</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center flex-wrap gap-4 mb-4">
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-forest">Customer Reviews</h3>
                            ...
                            @if (!$userHasReviewed)
                                <button type="button" id="write-review-btn" class="bg-forest text-white px-4 py-2 rounded-lg hover:bg-opacity-90 transition-colors font-medium">
                                    Write a Review
                                </button>
                            @else
                        ...
                        <div id="review-modal" class="fixed inset-0 z-[9998] hidden" aria-modal="true" role="dialog">
                            ...
                            <div class="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-2xl shadow-xl p-6 z-10 max-h-[90vh] overflow-y-auto">
                                <div class="flex items-center justify-between mb-4">
                                    <h3 class="text-xl font-semibold text-forest">Write a Review</h3>
                                ...
                                <form method="POST" action="{{ route('customer.product.review.store', $product) }}">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <textarea id="review-comment" name="comment" rows="4" class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-gold/40 focus:border-forest" placeholder="Share your experience with this product (min 10 characters)..." required minlength="10" maxlength="2000">{{ old('comment') }}</textarea>
                                        @error('comment')
                                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="flex gap-3 justify-end">
                                        ...
                                        <button type="submit" class="px-4 py-2 rounded-lg bg-forest text-white hover:bg-opacity-90 font-medium">Submit Review</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="border-b border-gray-100 pb-6 last:border-0">
                                    <div class="flex items-start mb-4">
                                        <div class="flex-shrink-0">
                                            <div class="w-10 h-10 rounded-full bg-forest text-white flex items-center justify-center font-semibold text-sm">
                                                {{ $review->author_initials }}
                                            </div>
                                        </div>
                                        <div class="ml-4 flex-1 min-w-0">
                                            <h4 class="font-semibold text-forest">{{ $review->user->name }}</h4>
    ...
    <!-- Similar Products -->
    <div class="mt-12">
        <h2 class="text-2xl font-bold text-forest mb-6">You May Also Like</h2>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden group">
                <div class="relative">
                    ...
                    <div class="absolute top-2 left-2">
                        <span class="bg-forest text-white text-xs px-2 py-1 rounded-full">Premium</span>
                    </div>
                </div>
                <div class="p-4">
                    <h3 class="font-semibold text-forest">Female Pekin Duck</h3>
                    <div class="flex items-center mt-1">
                    ...
                    <div class="mt-2">
                        <span class="font-bold text-forest">₱2,300.00</span>
                    </div>
                    <button class="mt-3 w-full bg-gray-100 text-forest font-medium py-2 rounded-lg hover:bg-gray-200 transition-colors">
                        View Details
                    </button>
                </div>
            </div>
...
<script>
    ...
    function openTab(evt, tabName) {
        ...
        for (let i = 0; i < tabButtons.length; i++) {
            tabButtons[i].className = tabButtons[i].className.replace(" text-forest border-b-2 border-forest", " text-stone-500 hover:text-forest");
        }

        document.getElementById(tabName).style.display = "block";
        evt.currentTarget.className += " text-forest border-b-2 border-forest";
    }
