    ...
    <div class="flex-grow container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-4 rounded-lg shadow-md">
                <img src="{{ asset('images/Female_Pekin_duck.jpg') }}" alt="Duck Products" class="w-full h-32 object-cover rounded mb-4">
                <h3 class="text-xl font-semibold mb-4 text-primary">Duck Products</h3>
                <a href="{{ route('cart.view') }}" class="text-neutral hover:text-primary transition-colors">View Duck Products</a>
            </div>
