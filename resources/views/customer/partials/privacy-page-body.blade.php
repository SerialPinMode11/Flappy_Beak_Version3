                    ...
                    <div class="prose max-w-none">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                            ...
                            <div class="text-gray-700 space-y-1">
                                ...
                                <p><strong>Contact:</strong> {{ config('contact.owner_phone_display') }} Â· jmcasabar@gmail.com</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-6 mb-6">
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                            ...
                            <ul class="space-y-2 text-blue-700">
                                ...
                                <li>â€¢ Mailing address</li>
                                <li>â€¢ Date of birth (for age verification)</li>
                            </ul>
                        </div>
                        <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                            ...
                            <ul class="space-y-2 text-purple-700">
                                ...
                                <li>â€¢ Delivery preferences</li>
                                <li>â€¢ Product preferences</li>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                            ...
                            <ul class="space-y-2 text-green-700">
                                <li>â€¢ Customer service inquiries</li>
                                <li>â€¢ Feedback and reviews</li>
                                <li>â€¢ Survey responses</li>
                                <li>â€¢ Marketing preferences</li>
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                            ...
                            <ul class="space-y-2 text-green-700">
                                ...
                                <li>â€¢ Secure servers and databases</li>
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                            ...
                            <ul class="space-y-2 text-blue-700">
                                ...
                                <li>â€¢ Data breach response procedures</li>
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                            ...
                            <div class="space-y-2 text-blue-700">
                                ...
                                <p class="flex items-center">
                                    ...
                                    {{ config('contact.owner_phone_display') }}
                                </p>
                                <p class="flex items-center">
