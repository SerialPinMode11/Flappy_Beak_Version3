                        ...
                        <div class="px-6 pb-5 text-gray-600 leading-relaxed">
                            ...
                            <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                                ...
                                <ul class="space-y-1 text-yellow-700">
                                    <li>â€¢ Orders of 10+ items</li>
                                    <li>â€¢ Orders exceeding â‚±5,000</li>
                                    <li>â€¢ Custom quotes available</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 pb-5 text-gray-600 leading-relaxed">
                            ...
                            <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                ...
                                <ul class="space-y-1 text-purple-700">
                                    <li>â€¢ Unique and refreshing local wine</li>
                                    <li>â€¢ Distinctive Filipino flavor profile</li>
                                    <li>â€¢ Farm-to-bottle freshness</li>
                                    <li>â€¢ Traditional crafting methods</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 pb-5 text-gray-600 leading-relaxed">
                            <div class="bg-blue-50 p-4 rounded-lg border border-blue-200">
                                ...
                                <ul class="space-y-2 text-blue-700">
                                    <li>â€¢ <span class="font-medium">Temperature:</span> 10-15Â°C (50-59Â°F)</li>
                                    <li>â€¢ <span class="font-medium">Location:</span> Cool, dark place</li>
                                    <li>â€¢ <span class="font-medium">Position:</span> Store horizontally if cork-sealed</li>
                                    <li>â€¢ <span class="font-medium">Environment:</span> Away from direct sunlight and strong odors</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 pb-5 text-gray-600 leading-relaxed">
                            <div class="grid md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                                    ...
                                    <ul class="space-y-1 text-yellow-700">
                                        <li>â€¢ Fresh duck eggs</li>
                                        <li>â€¢ Salted duck eggs</li>
                                        <li>â€¢ Balut (fertilized eggs)</li>
                                        <li>â€¢ Penoy (unfertilized balut)</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="faq-answer">
                        <div class="px-6 pb-5 text-gray-600 leading-relaxed">
                            ...
                            <div class="bg-green-50 p-4 rounded-lg border border-green-200">
                                ...
                                <ul class="space-y-1 text-green-700">
                                    <li>â€¢ Spacious, clean living environments</li>
                                    <li>â€¢ Access to natural foraging areas</li>
                                    <li>â€¢ Clean, fresh water supply</li>
                                    <li>â€¢ Regular veterinary care</li>
                                    <li>â€¢ Stress-free handling procedures</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 pb-5 text-gray-600 leading-relaxed">
                            ...
                            <div class="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
                                ...
                                <ul class="space-y-1 text-indigo-700">
                                    <li>â€¢ Modern, reliable incubators</li>
                                    <li>â€¢ Controlled environment</li>
                                    <li>â€¢ Optimal conditions throughout incubation</li>
                                    <li>â€¢ Professional monitoring</li>
                                </ul>
                            </div>
                        </div>
                    </div>
