        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('admin.register') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" class="w-full p-3 border border-gray-700 bg-gray-800 text-white rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-colors" required>
                </div>
                <div>
            ...
            <div class="mt-8">
                ...
                <a href="{{ route('admin.login') }}" class="mt-2 inline-block text-primary hover:text-accent transition-colors font-semibold">
                    Login your Account
                </a>
